...
export default function AdminPage() {
  ...
  // --- LÓGICA DE LOGIN (Agora verifica na lista) ---
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    
    // Procura se existe algum usuário na lista com esse login e senha
    const adminEncontrado = listaAdmins.find(
      (admin) => admin.usuario === inputUsuario && admin.senha === inputSenha
    );
